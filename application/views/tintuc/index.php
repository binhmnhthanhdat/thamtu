                    ...
                    <div class="content">
                        ...
                        <?php 
                            ...
                            <div class="box_dau_left">
                                <div class="anh">
                                    <a   href="<?php  echo base_url();?><?php  echo $function; ?>/<?php  echo $kqlaytinmoi->alias;?>" title="<?php  echo $kqlaytinmoi->title; ?>"><img src="<?php  echo base_url(); echo $kqlaytinmoi->img;?>" alt="<?php  echo $kqlaytinmoi->title; ?>"  /></a>
                                </div>
                                <div class="noidung">
                                    <div class="tieude">
                            ...
                            <div class="box_dau_right">
                                   <p class="tinnoibat" style="font-size: 16px;" >Tin tức nổi bật</p>
									...
									<?php 
                                         ...
                                         <?php  
                                                                }//end if($kqlaytinmoi->id!=$id_tindau)
                                                             } //end so group 
                                                 }
                                        ?>      
                                    </ul>
