					 ...
					 $sorecord=1;
						...
						?>
							<div class="boxtin <?php if($sorecord%3==0) echo "right";?> boxtin_dichvu">								
								...
								<p>
									<img class="caption" src="<?php  echo base_url(); echo $kqlaygroupproject->images;?>" alt="<?php  echo $kqlaygroupproject->title;?>" title="<?php  echo $kqlaygroupproject->title;?>" border="0" height="100" width="100" />
