                    ...
                    <div class="ContentMain">
                        ...
                        <div class="fixTopContent3 padL35">
                            ...
                            <ul class="listProject">
                                      ...
                                      ?>
                                        <li>
                                        	<p><a href="<?php  echo base_url();?>chi-tiet-du-an/<?php  echo $kqlayallproject->alias;?>" title="<?php  echo $kqlayallproject->title;?>"><img src="<?php  echo base_url(); echo $kqlayallproject->img;?>" alt="<?php  echo $kqlayallproject->title;?>"  class="img_duan" /></a></p>
                                            <p class="padT7"> 
