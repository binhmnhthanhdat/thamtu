         ...
         <div class="ContentMain" >
  	        <div class="box_tag" >
               ...
               if($laytinproject->num_rows()>0)
                ...
                ?>
                        <div class="list_tag">
                        	<a href="<?php  echo base_url();?><?php echo $function ?>/<?php  echo $kqlaytinproject->alias;?>" title="<?php  echo $kqlaytinproject->title;?>" class="image_tag"><img src="<?php  echo base_url(); echo $kqlaytinproject->img;?>" alt="<?php  echo $kqlaytinproject->title;?>" class="flLeft" /></a>
                            <div class="content" >
