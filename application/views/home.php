...
<div class="clearFix"></div>
<div class="boxContact marT40">
   <div class="flLeft fone">
      <div class="clearFix padB10"></div>
      <div class="flLeft hotline hotlinefirst" style="margin-top:40px;">
         <p class="fontsize15 padT40 bold" style="color: #000000; font-size:15px;">DỊCH VỤ THÁM TỬ</p>
         <p class="colorRed fontsize19 bold padT3">09696.51115</p>
      </div>
      <div class="rulerRight flLeft"  style="margin-top:30px; "></div>
      <div class="flLeft hotline"  style="margin-top:40px;">
         <p class="fontsize15 padT40 bold" style="color: #000000; font-size:15px;">CÔNG TY THÁM TỬ</p>
         <p class="colorRed fontsize19 bold padT3">09696.51115</p>        
      </div>
   </div>
   <div class="anhlienhe"><img src="<?echo base_url(); ?>images/project/lien-he-dich-vu-tham-tu.png" alt="lien-he-dich-vu-tham-tu" width="150px" height="175px;"/></div>
   <div class="clearFix"></div>
</div>
<div class="shutContact padB20"></div>
<div class="tintuc">
   <?php
...
foreach ($layboxtext->result() as $kqlayboxtext) {
        ...
        ?>
   <div class="ghichu"><img  title="tham-tu-tu-hieu-qua" alt="tham-tu-tu-hieu-qua" src=" <?php echo base_url(); ?>images/news/hop-tac-tham-tu-uy-tin.png" style="float: left;" /><?php echo $kqlayboxtext->title; ?></div>
