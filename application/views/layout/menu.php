...
?>
        ...
        <div class="menuBar" id="ddtopmenubar">
                     ...
                     <?php 
                           ...
                           if($laymenu->num_rows()>0)
                           {
                            foreach($laymenu->result()  as $kqlaymenu)
								{
								    ?>
                        			<li><a  href="<?php   if($kqlaymenu->type==1){
                            echo base_url('cong-ty');
                            }else if($kqlaymenu->type==2){echo base_url('gia-thue-dich-vu-tham-tu');
                             }
                            else if($kqlaymenu->type==3){echo base_url('du-an');
				...
				<div class="group_tieude">
					<h1 style = "display: block; padding-right: 10px;" class="tieude" title="<?php   if(isset($title)) { echo $title; } else { echo $kqsetting->site_name;}?>"><?php   if(isset($title)) { echo $title; } else { echo $kqsetting->site_name;}?></h1>
