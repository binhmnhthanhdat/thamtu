...
class Gioithieu extends CI_Controller {
    ...
    function index($id=null){
          ...
          // $data['description']="Giới thiệu";   
          // $data['keywords']="Giới thiệu";  
           ...
           //$titlegioithieu=$this->Gioithieu_model->laygioithieu($id);
           $data['laygioithieu']=$this->Gioithieu_model->laygioithieu($id);
          //$kqtitlegioithieu=$titlegioithieu->row();
          // $data['title']=$kqtitlegioithieu->title;  
          ...
          //$titlegioithieu=$this->Gioithieu_model->laygioithieu('tong-quan-ve-pinet');
   ...
   function banggia(){
       //echo "Sdfdsf:"; exit;
           $data['laygrouptintuc']=$this->Gioithieu_model->laygrouptintuc(); 
			...
			// echo "<pre>";
			// print_r($data['laygioithieu']->result());
			// echo "</pre>";
           $kqlaytitle=$data['laygioithieu']->row();
           $data['title']=$kqlaytitle->title;    
		   //echo "Xcxc".$data['title'];exit;
           $data['description']=$kqlaytitle->metadescription;  
           $data['keywords']=$kqlaytitle->metakeyword; 
